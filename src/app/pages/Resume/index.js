...
import { Container, DownloadButtonWrapper, DownloadButton } from "./elements";
import "./index.scss";
...
- 软件(工具): IntelliJ IDEA, Visual Studio Code, OS Terminal, Data Manager Tools, Web Browser, Webpack, NPM, Apache Maven, Gradle, Jenkins, Tomcat, Nginx, Docker
  ...
  render() {
    return (
      <Container className="md-view">
        <Markdown source={RESUME_MD} />
        <DownloadButtonWrapper onClick={
          () => {
            window.open("http://www.xulingming.cn/v1/api/users/mypr");
          }
        }>
          <DownloadButton>
